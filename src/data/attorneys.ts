...
export const attorneys: Attorney[] = [
  ...
  },
  {
    ...
    notableCases: [
      ...
      "Assisted in an ASIC investigation resulting in no enforcement action (2022)",
